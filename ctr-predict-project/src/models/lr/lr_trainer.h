#ifndef _CTR_PREDICT_LR_TRAINER_H_
#define _CTR_PREDICT_LR_TRAINER_H_
...
class LrTrainer : public BaseTrainer{
    public:
        LrTrainer(TrainerOption * opt);
    ...
    private:
        std::shared_ptr<LrModel> _p_model;
};
